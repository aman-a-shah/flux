...
const mainNavItems = [
  ...
  { icon: FolderOpen, label: "All Sessions", href: "/dashboard/sessions" },
  { icon: MessageSquare, label: "Assistant", href: "/dashboard/assistant" },
];
  ...
  return (
    <div className="flex h-screen border-r border-zinc-200 bg-zinc-50 shrink-0">
      ...
      <div className="w-[60px] flex flex-col items-center py-4 border-r border-zinc-200 bg-white z-20 shadow-sm">
        <div className="w-10 h-10 rounded-xl bg-indigo-50 flex items-center justify-center mb-8 border border-indigo-100 shadow-sm">
